Ext.define('mvc.model.pur.PurRev',{
extend : 'Ext.data.Model',
idProperty : 'bean.pkey',
proxy : {
	type : 'ajax',
	url : base_path+'/pur_PurRev_load'
},
fields : [{name : 'bean.pkey',mapping : 'pkey',type : 'int',useNull : true}
	...
	,{name : 'bean.amtDj',mapping : 'amtDj',type : 'float',useNull : true}
	,{name : 'bean.buyer',mapping : 'buyer',type : 'string',outkey : true}
	,{name : 'bean.billFlag',mapping : 'billFlag',type : 'int',useNull : true}
	,{name : 'bean.settleFlag',mapping : 'settleFlag',type : 'int',useNull : true}
