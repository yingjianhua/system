Ext.define('mvc.model.pur.PurMvIn',{
extend : 'Ext.data.Model',
idProperty : 'bean.pkey',
proxy : {
	type : 'ajax',
	url : base_path+'/pur_PurMvIn_load'
},
fields : [{name : 'bean.pkey',mapping : 'pkey',type : 'int',useNull : true}
	...
	,{name : 'bean.goodsTo',mapping : 'goodsTo',type : 'int',useNull : true}
	...
	,{name : 'bean.outForm',mapping : 'outForm',type : 'string',outkey : true}
