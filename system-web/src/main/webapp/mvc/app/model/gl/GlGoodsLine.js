Ext.define('mvc.model.gl.GlGoodsLine',{
extend : 'Ext.data.Model',
idProperty : 'bean.pkey',
proxy : {
	type : 'ajax',
	url : base_path+'/gl_GlGoodsLine_load'
},
fields : [{name : 'bean.pkey',mapping : 'pkey',type : 'int',useNull : true}
	...
	,{name : 'bean.balanceQty',mapping : 'balanceQty',type : 'float',useNull : true}
	,{name : 'bean.balance',mapping : 'balance',type : 'float',useNull : true}
	,{name : 'bean.daybookLine',mapping : 'daybookLine',type : 'string',outkey : true}
