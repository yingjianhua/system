Ext.define('mvc.model.rp.RpNotePayBill',{
extend : 'Ext.data.Model',
idProperty : 'bean.pkey',
proxy : {
	type : 'ajax',
	url : base_path+'/rp_RpNotePayBill_load'
},
fields : [{name : 'bean.pkey',mapping : 'pkey',type : 'int',useNull : true}
	...
	,{name : 'bean.payDate',mapping : 'payDate',type : 'date'}
	,{name : 'bean.name',mapping : 'name',type : 'string'}
	,{name : 'bean.account',mapping : 'account',type : 'string'}
	,{name : 'bean.bank',mapping : 'bank',type : 'string'}
