Ext.define('mvc.view.frm.FrmHandover.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.frm.FrmHandover.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.frm.FrmHandover.ListForm',{height : 300,border : false })
	}];
