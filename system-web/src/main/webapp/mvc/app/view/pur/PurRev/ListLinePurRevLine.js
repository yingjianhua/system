Ext.define('mvc.view.pur.PurRev.ListLinePurRevLine',{
...
initComponent : function(){
	...
	,{text : '实收数量',width : 100,dataIndex : 'bean.receivedQty',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
	];
