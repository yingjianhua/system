Ext.define('mvc.view.pur.PurOrder.ListLinePurOrderLine',{
...
initComponent : function(){
	...
	,{text : '采购成本',width : 100,dataIndex : 'bean.costPur',sortable : true,renderer : mvc.Tools.numberRenderer(),align : 'right'}
	,{text : '开单数量',width : 100,dataIndex : 'bean.qtyOpen',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
	];
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.pur.PurOrderLine');
