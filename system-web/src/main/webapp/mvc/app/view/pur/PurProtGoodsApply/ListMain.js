Ext.define('mvc.view.pur.PurProtGoodsApply.ListMain',{
...
this.columns =[{text : '单据号',width : 135,dataIndex : 'bean.code',sortable : true}
	...
	,{text : '科目模板',width : 100,dataIndex : 'bean.templat',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'sys',mn : 'view.sys.SysTemplat.List'}
	...
	,{text : '备注',width : 100,dataIndex : 'bean.rem',sortable : true}
		...
		this.store=Ext.create('mvc.store.pur.PurProtGoodsApply');
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.pur.PurProtGoodsApply', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/pur_PurProtGoodsApply_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),
