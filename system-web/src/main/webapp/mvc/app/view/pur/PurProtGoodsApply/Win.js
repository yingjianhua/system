Ext.define('mvc.view.pur.PurProtGoodsApply.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.pur.PurProtGoodsApply.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.pur.PurProtGoodsApplyLine.List',{height : 300,border : false,itemId : 'PurProtGoodsApplyLine',parent : this})
	}];
