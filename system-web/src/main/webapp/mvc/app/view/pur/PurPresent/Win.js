Ext.define('mvc.view.pur.PurPresent.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.pur.PurPresent.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.pur.PurPresent.ListForm',{height : 300,border : false })
	}];
