Ext.define('mvc.view.pur.PurOrder.ListMain',{
...
this.columns =[{text : '单据号',width : 135,dataIndex : 'bean.code',sortable : true}
	...
	,{text : '开单状态',width : 100,dataIndex : 'bean.ordStatus',sortable : true,renderer : mvc.Tools.optRenderer('pur','Pur','OOrderStatus'),expandCol : true,hidden : true}
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.pur.PurOrder', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/pur_PurOrder_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),
