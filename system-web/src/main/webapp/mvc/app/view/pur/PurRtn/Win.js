Ext.define('mvc.view.pur.PurRtn.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.pur.PurRtn.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.pur.PurRtn.ListForm',{height : 300,border : false })
	}];
