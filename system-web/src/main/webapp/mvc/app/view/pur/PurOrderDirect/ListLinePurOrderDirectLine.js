Ext.define('mvc.view.pur.PurOrderDirect.ListLinePurOrderDirectLine',{
...
initComponent : function(){
	...
	,{text : '采购成本',width : 100,dataIndex : 'bean.costPur',sortable : true,renderer : mvc.Tools.numberRenderer(),align : 'right'}
		...
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.pur.PurOrderDirectLine');
