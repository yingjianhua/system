Ext.define('mvc.view.rp.RpNotePayBill.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'RpNotePayBill_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
...
this.onBetween(newv,this.oldId + 'tranTime',this.oldId + 'tranTimeEd',this.oldId + 'tranTime_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'tranTime',
									format : 'Y-m-d H:i:s',
									itemId : this.oldId + 'tranTime'
								},{
									xtype : 'datefieldexp',
									name : 'tranTimeEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'tranTimeEd'
								}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											...
											listeners : {
												scope : this,
												change : function(field,newv,oldv,opts){
this.onBetween(newv,this.oldId + 'payDate',this.oldId + 'payDateEd',this.oldId + 'payDate_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'payDate',
									format : 'Y-m-d',
									itemId : this.oldId + 'payDate'
								},{
									xtype : 'datefieldexp',
									name : 'payDateEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'payDateEd'
								}
