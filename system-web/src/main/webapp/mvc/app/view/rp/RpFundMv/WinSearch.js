Ext.define('mvc.view.rp.RpFundMv.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'RpFundMv_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
...
this.onBetween(newv,this.oldId + 'sourceTime',this.oldId + 'sourceTimeEd',this.oldId + 'sourceTime_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'sourceTime',
									format : 'Y-m-d H:i:s',
									itemId : this.oldId + 'sourceTime'
								},{
									xtype : 'datefieldexp',
									name : 'sourceTimeEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'sourceTimeEd'
								}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											...
											listeners : {
												scope : this,
												change : function(field,newv,oldv,opts){
this.onBetween(newv,this.oldId + 'descTime',this.oldId + 'descTimeEd',this.oldId + 'descTime_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'descTime',
									format : 'Y-m-d H:i:s',
									itemId : this.oldId + 'descTime'
								},{
									xtype : 'datefieldexp',
									name : 'descTimeEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'descTimeEd'
								}
