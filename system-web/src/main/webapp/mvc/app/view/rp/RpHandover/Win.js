Ext.define('mvc.view.rp.RpHandover.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.rp.RpHandover.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.rp.RpHandover.ListForm',{height : 300,border : false })
	}];
