Ext.define('mvc.view.rp.RpNoteRptBill.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'RpNoteRptBill_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											...
											listeners : {
												scope : this,
												change : function(field,newv,oldv,opts){
this.onBetween(newv,this.oldId + 'receiveDate',this.oldId + 'receiveDateEd',this.oldId + 'receiveDate_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'receiveDate',
									format : 'Y-m-d',
									itemId : this.oldId + 'receiveDate'
								},{
									xtype : 'datefieldexp',
									name : 'receiveDateEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'receiveDateEd'
								}
