Ext.define('mvc.view.gl.GlReport.ListMain', {
	...
	initComponent : function() {
		this.columns = [{
					...
					renderer: function(value, cellmeta, record) { 
						...
						if(record.get('bean.tableType')==4) {
							if(record.get('bean.valueType')!=3) {
								before += "&nbsp&nbsp&nbsp&nbsp";								
							}
						}else if(record.get('bean.valueType')!=9) {
							before += "&nbsp&nbsp&nbsp&nbsp";
						}
						var display = '<div onmouseout=\'lastChild.src="#"\' onmouseover=\'lastChild.src="../extfile/images/mvc/page_edit.gif"\'>'+before+value+'<input id="update" class="update" type="image" data-qtip="修改" alt="&nbsp&nbsp&nbsp"></div>';
