Ext.define('mvc.view.gl.GlReport.ListMainL', {
	...
	initComponent : function() {
		this.columns = [{
					...
					renderer: function(value, cellmeta, record) { 
						if(record.get('bean.keyValue')!=1&&record.get('bean.valueType')!=3) {
							value = "&nbsp&nbsp&nbsp&nbsp&nbsp"+value;								
						} else {
							value = "&nbsp"+value;
						}
						if(record.get('bean.valueType')==1) {
							value = '<div onmouseout=\'lastChild.src="#"\' onmouseover=\'lastChild.src="../extfile/images/mvc/page_edit.gif"\'>'
						+value+'<input id="update" class="update" type="image" data-qtip="设置" alt="&nbsp&nbsp&nbsp"></div>';
						}
                    	return value; 
					},
					listeners:{ 
