Ext.define('mvc.view.gl.GlJournal.List',{
extend : 'Ext.panel.Panel',
oldId : 'GlJournal_list_',
loadMask : true,
multiSelect : true,
roles : '',
layout : 'border',
...
mainActs.push({
		...
		items : [{
				xtype : Ext.create('mvc.view.gl.GlJournal.ListMain',{
							title : '分户账',
							...
							listeners : 							 {
				                ...
				                selectionchange: function(model, records) {
				                    if (records.length === 1){
        								...
        								this.mdLineTable.store.filter([{'id':'filter', 'property':'mainPkey','value':records[0].get('bean.pkey')}]);
    									if (this.roles.indexOf('upd') != -1)
				...
				xtype : Ext.create('mvc.view.gl.GlJournal.ListLineGlJournalLine',{
							title : '普通分户账明细',
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg, 
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/gl_GlJournal_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
