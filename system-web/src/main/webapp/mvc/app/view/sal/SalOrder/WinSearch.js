Ext.define('mvc.view.sal.SalOrder.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'SalOrder_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
							...
							,{xtype : 'numberfield',name : 'earnest',decimalPrecision : 2}
						...
						,{
							...
							,mvc.Tools.crtComboForm(true,{
											name : 'ordStatus',
											store : Ext.create('mvc.combo.sal.SalOOrderStatus')
										})
