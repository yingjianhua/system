Ext.define('mvc.view.sal.SalRtn.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.sal.SalRtn.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.sal.SalRtn.ListForm',{height : 250,border : false })
	}];
