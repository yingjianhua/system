Ext.define('mvc.view.sal.SalOrder.ListLineSalOrderLine',{
...
initComponent : function(){
	...
	,{text : '销售费用',width : 100,dataIndex : 'bean.expensesSale',sortable : true,renderer : mvc.Tools.numberRenderer(),align : 'right'}
	,{text : '开单数量',width : 100,dataIndex : 'bean.qtyOpen',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
	];
