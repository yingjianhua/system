Ext.define('mvc.view.sal.SalSaleDirect.ListMain',{
...
this.columns =[{text : '单据号',width : 135,dataIndex : 'bean.code',sortable : true}
	...
	,{text : '销售订单',width : 100,dataIndex : 'bean.ord',sortable : true,renderer : mvc.Tools.beanRendererHref(),expandCol : true,hidden : true,md : 'sal',mn : 'view.sal.SalOrder.List'}
	...
	,{text : '发货人',width : 75,dataIndex : 'bean.shipBy',sortable : true,renderer : mvc.Tools.beanRendererHref(),expandCol : true,hidden : true,md : 'sys',mn : 'view.sys.SysUser.List'}
	...
	,{text : '机构',width : 100,dataIndex : 'bean.org',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'sys',mn : 'view.sys.SysOrg.List'}
		...
		this.store=Ext.create('mvc.store.sal.SalSaleDirect');
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.sal.SalSaleDirect', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/sal_SalSaleDirect_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),
