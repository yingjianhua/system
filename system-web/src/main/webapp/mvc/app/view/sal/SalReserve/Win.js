Ext.define('mvc.view.sal.SalReserve.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.sal.SalReserve.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.sal.SalReserve.ListForm',{height : 300,border : false })
	}];
