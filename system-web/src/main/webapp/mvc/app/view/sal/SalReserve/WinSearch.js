Ext.define('mvc.view.sal.SalReserve.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'SalReserve_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
...
this.onBetween(newv,this.oldId + 'expireDate',this.oldId + 'expireDateEd',this.oldId + 'expireDate_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'expireDate',
									format : 'Y-m-d',
									itemId : this.oldId + 'expireDate'
								},{
									xtype : 'datefieldexp',
									name : 'expireDateEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'expireDateEd'
								}
