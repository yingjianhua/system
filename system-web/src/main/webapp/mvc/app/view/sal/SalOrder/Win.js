Ext.define('mvc.view.sal.SalOrder.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.sal.SalOrder.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.sal.SalOrder.ListForm',{height : 250,border : false })
	}];
