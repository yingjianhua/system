Ext.define('mvc.view.sal.SalOrder.ListForm',{
...
,{text : '数量',width : 100,dataIndex : 'bean.qty',sortable : true,align : 'right',renderer : mvc.Tools.numberRenderer(4),editor : {xtype : 'numberfield',decimalPrecision : 4}
	...
	,{text : '金额',width : 120,dataIndex : 'bean.amt',sortable : true,renderer : mvc.Tools.numberRenderer(),align : 'right'
		...
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.sal.SalOrderLine');
...
onIns : function(){
		var model = Ext.create('mvc.store.sal.SalOrderLine');
