Ext.define('mvc.view.sal.SalPresent.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.sal.SalPresent.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.sal.SalPresent.ListForm',{height : 250,border : false })
	}];
