Ext.define('mvc.view.sal.SalRtn.ListLineSalRtnLine',{
...
initComponent : function(){
	...
	,{text : '原价',width : 100,dataIndex : 'bean.priceOld',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
	];
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.sal.SalRtnLine');
