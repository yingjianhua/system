Ext.define('mvc.view.sal.SalOrder.Form',{
...
({xtype : 'textfield',name : 'bean.code',fieldLabel : '单据号',readOnly : true}
	...
	,
		mvc.Tools.crtComboForm(false,{
					name : 'bean.salType',
					fieldLabel : '销售类型',
					store : Ext.create('mvc.combo.sal.SalOSalType'),
					value : 1
				})
	,
		mvc.Tools.crtComboForm(false,{
					name : 'bean.speType',
					fieldLabel : '订单类型',
					store : Ext.create('mvc.combo.pur.PurOSpeType'),
					value : 1
				})
	,{xtype : 'numberfield',name : 'bean.earnest',value : '0',afterLabelTextTpl : required,allowBlank : false,fieldLabel : '订金',decimalPrecision : 2}
	,{
		xtype : 'beantrigger',
		name : 'bean.operator',
		fieldLabel : '业务员',
