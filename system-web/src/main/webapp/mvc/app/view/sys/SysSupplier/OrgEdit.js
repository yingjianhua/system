Ext.define('mvc.view.sys.SysSupplier.OrgEdit',{
...
var mainActs =[{
		...
		handler : this.onReset
			...
			if (this.isEdit)
				this.tbar=mainActs;
this.columns = [{text : '关联机构 ',width : 120,dataIndex : 'bean.org',sortable : true,renderer : mvc.Tools.beanRenderer(),
	editor: {
...
onIns : function(){
		var model = Ext.create('mvc.model.sys.SysSupplierOrg');
...
onReset : function(){
		this.store.filter([{'property':'supplier','value':this.mainPkey}]);
},
