Ext.define('mvc.view.cst.CstSalInvoice.ListLineCstSalInvoiceLine',{
...
initComponent : function(){
	...
	,{text : '金额',width : 100,dataIndex : 'bean.amt',sortable : true,renderer : mvc.Tools.numberRenderer(),align : 'right'}
		...
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.cst.CstSalInvoiceLine');
