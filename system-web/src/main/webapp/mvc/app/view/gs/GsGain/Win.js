Ext.define('mvc.view.gs.GsGain.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsGain.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsGain.ListForm',{height : 300,border : false })
	}];
