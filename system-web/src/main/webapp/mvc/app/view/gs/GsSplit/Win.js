Ext.define('mvc.view.gs.GsSplit.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsSplit.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsSplit.ListForm',{height : 300,border : false })
	}];
