Ext.define('mvc.view.gs.GsReportMvOut.List',{
extend : 'Ext.grid.Panel',
oldId : 'btn_GsReportMvOut',
lock : true,
...
var mainActs = [];this.columns = [{text : '出库单号',width : 100,dataIndex : 'bean.code',sortable : true}
	...
	,{text : '数量',width : 100,dataIndex : 'bean.qty',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
		...
		if (mainActs.length > 0)
			this.tbar=mainActs;
		this.store=Ext.create('mvc.store.gs.GsReportMvOut'); 
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.gs.GsReportMvOut.WinSearch',{
