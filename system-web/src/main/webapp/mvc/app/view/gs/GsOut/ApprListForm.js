Ext.define('mvc.view.gs.GsOut.ApprListForm', {
...
//			}
		...
		this.store = Ext.create('mvc.store.gs.GsOutLineView');
//		this.store.proxy.url = base_path + '/gs_GsOutLineView_listAppr';
	...
	onIns : function() {
		var model = Ext.create('mvc.store.gs.GsOutLine');
