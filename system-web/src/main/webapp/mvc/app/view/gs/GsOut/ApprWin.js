Ext.define('mvc.view.gs.GsOut.ApprWin', {
	...
	initComponent : function() {
		this.items = [{
			anchor : '100%',
			plain : true,
			xtype : Ext.create('mvc.view.gs.GsOut.ApprForm',{
				pkey : this.pkey
			})
		},{
			xtype : Ext.create('mvc.view.gs.GsOut.ApprListForm',{
				height : 300,
				border : false,
	...
	setActiveRecord : function(record) {
		...
		if (record || this.form.activeRecord) {
			...
			this.form.down('[name=bean.outTime]').setValue(new Date());
