Ext.define('mvc.view.gs.GsPriceGoodsCell.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'GsPriceGoodsCell_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
