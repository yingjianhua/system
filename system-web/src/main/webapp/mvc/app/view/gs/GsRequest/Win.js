Ext.define('mvc.view.gs.GsRequest.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsRequest.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsRequest.ListForm',{height : 300,border : false })
	}];
