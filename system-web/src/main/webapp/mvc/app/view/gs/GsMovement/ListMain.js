Ext.define('mvc.view.gs.GsMovement.ListMain',{
...
this.columns =[{text : '单据号',width : 135,dataIndex : 'bean.code',sortable : true}
	,{text : '调出仓库',width : 100,dataIndex : 'bean.warehouseOut',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'gs',mn : 'view.gs.GsWarehouse.List'}
	,{text : '调入仓库',width : 100,dataIndex : 'bean.warehouseIn',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'gs',mn : 'view.gs.GsWarehouse.List'}
	...
	,{text : '备注',width : 100,dataIndex : 'bean.rem',sortable : true}
		...
		this.store=Ext.create('mvc.store.gs.GsMovement');
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.gs.GsMovement', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/gs_GsMovement_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),
