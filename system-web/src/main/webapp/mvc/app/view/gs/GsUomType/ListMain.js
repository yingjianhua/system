Ext.define('mvc.view.gs.GsUomType.ListMain',{
...
this.columns =[{text : '名称',width : 100,dataIndex : 'bean.name',sortable : true}
	...
	,{text : '备注',width : 100,dataIndex : 'bean.rem',sortable : true}
		...
		this.store=Ext.create('mvc.store.gs.GsUomType');
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.gs.GsUomType', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/gs_GsUomType_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),
