Ext.define('mvc.view.gs.GsReportPurIn.List',{
extend : 'Ext.grid.Panel',
oldId : 'btn_GsReportPurIn',
lock : true,
...
var mainActs = [];this.columns = [{text : '入库单号',width : 100,dataIndex : 'bean.code',sortable : true}
	,{text : '入库时间',width : 140,dataIndex : 'bean.inTime',sortable : true,renderer : Ext.util.Format.dateRenderer('Y-m-d H:i:s')}
	...
	,{text : '数量',width : 100,dataIndex : 'bean.qty',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right'}
		...
		if (mainActs.length > 0)
			this.tbar=mainActs;
		this.store=Ext.create('mvc.store.gs.GsReportPurIn'); 
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.gs.GsReportPurIn.WinSearch',{
