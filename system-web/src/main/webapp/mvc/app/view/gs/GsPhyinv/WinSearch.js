Ext.define('mvc.view.gs.GsPhyinv.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'GsPhyinv_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
...
this.onBetween(newv,this.oldId + 'planFiniDate',this.oldId + 'planFiniDateEd',this.oldId + 'planFiniDate_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'planFiniDate',
									format : 'Y-m-d',
									itemId : this.oldId + 'planFiniDate'
								},{
									xtype : 'datefieldexp',
									name : 'planFiniDateEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'planFiniDateEd'
								}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											...
											listeners : {
												scope : this,
												change : function(field,newv,oldv,opts){
this.onBetween(newv,this.oldId + 'finiTime',this.oldId + 'finiTimeEd',this.oldId + 'finiTime_empty');this.doLayout();											}
											}
										})
							,{
									xtype : 'datefield',
									name : 'finiTime',
									format : 'Y-m-d H:i:s',
									itemId : this.oldId + 'finiTime'
								},{
									xtype : 'datefieldexp',
									name : 'finiTimeEd',
									format : 'Y-m-d',
									hidden : true,
									itemId : this.oldId + 'finiTimeEd'
								}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_unmatchNum',
											width : 80,
											value : 3,
											store : numstore
										})
							,{xtype : 'numberfield',name : 'unmatchNum',allowDecimals : false}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_unmatchAmt',
											width : 80,
											value : 3,
											store : numstore
										})
							,{xtype : 'numberfield',name : 'unmatchAmt',decimalPrecision : 2}
