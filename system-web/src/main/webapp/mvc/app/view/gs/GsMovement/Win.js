Ext.define('mvc.view.gs.GsMovement.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsMovement.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsMovement.ListForm',{height : 300,border : false })
	}];
