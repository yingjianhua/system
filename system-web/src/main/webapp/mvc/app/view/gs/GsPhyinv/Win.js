Ext.define('mvc.view.gs.GsPhyinv.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsPhyinv.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsPhyinv.ListForm',{height : 300,border : false })
	}];
