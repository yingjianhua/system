Ext.define('mvc.view.gs.GsLoss.ListForm',{
...
,{text : '数量',width : 100,dataIndex : 'bean.qty',sortable : true,renderer : mvc.Tools.numberRenderer(4),align : 'right',editor : {xtype : 'numberfield',decimalPrecision : 4}
	...
	,{text : '计量单位',width : 75,dataIndex : 'bean.uom',sortable : true,renderer : mvc.Tools.beanRenderer(),editor : {xtype : 'beantriggercell',bean : 'GsUom',beanType : 'gs',beanName : 'bean.uom',grid : this,emptyText : form_empty_text}
		...
		mvc.Tools.doGoodsLine(this.columns, 1);		this.store=Ext.create('mvc.store.gs.GsLossLine');
...
onIns : function(){
		var model = Ext.create('mvc.store.gs.GsLossLine');
