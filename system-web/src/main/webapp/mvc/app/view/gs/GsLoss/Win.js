Ext.define('mvc.view.gs.GsLoss.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsLoss.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsLoss.ListForm',{height : 300,border : false })
	}];
