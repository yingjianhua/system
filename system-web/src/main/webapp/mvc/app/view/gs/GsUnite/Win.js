Ext.define('mvc.view.gs.GsUnite.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.gs.GsUnite.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.gs.GsUnite.ListForm',{height : 300,border : false })
	}];
